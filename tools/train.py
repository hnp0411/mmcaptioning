...
from mmcap import __version__
from mmcap.models import build_caption
from mmcap.apis import (set_random_seed, 
                        train_caption_model)
from mmcap.datasets import build_dataset
from mmcap.utils import get_root_logger, collect_env
...
#        x = datasets[0].__getitem__(i)
    ...
    if cfg.checkpoint_config is not None:
        cfg.checkpoint_config.meta = dict(
            mmcap_version = __version__ + get_git_hash()[:7])#,
